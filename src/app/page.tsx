    ...
    <>
      <section className={`${styles.homepage}`}>
        <Container className="pt-16 md:pt-38 flex w-full h-full flex-col justify-center">
          <TextGradient text="Unleash the Power of Your Text." className={`${roboto.className} capitalize text-4xl md:text-6xl text-center mb-8 md:mb-12 text-black font-extrabold tracking-wider delay-200`}/>
          <h2
            className={`${roboto.className} text-base font-bold md:font-normal md:text-3xl text-center text-black md:mb-3  mb-8`}
          >
            Elevate your learning with AI-enhanced dynamic Q&A creation. QnAI magically transforms your ordinary text into captivating interactive Q&A experiences. 
          </h2>
