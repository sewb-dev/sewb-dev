...
export const mockQNAIResponse = [
  ...
  },
  {
    ...
    options: ['Charge', 'Resting mass', 'Speed', 'Energy'],
    answer: 0,
    context:
  ...
  },
  {
    ...
    question:
      "Photon's contribution of wavelike characteristics to their behavior is insignificant. (True/False)",
    options: ['True', 'False'],
    answer: 1,
    context:
      'Since they are extremely small particles, the contribution of wavelike characteristics to the behavior of photons is significant.',
  },
  {
    id: 4,
    type: QuestionType.MULTIPLE_CHOICE,
  ...
  },
  {
    ...
    answer: 0,
    context:
      'Although they have never been observed, the longest theoretical wavelength of light is the size of the universe.',
  },
  {
    id: 6,
    type: QuestionType.MULTIPLE_CHOICE,
    question: 'What is the speed of light in empty space?',
    options: ['3x108 m/s', '2x108 m/s', '2.997x108 m/s', '3.5x108 m/s'],
    answer: 2,
    context:
      'Photons travel at the speed of light, 2.997x108 m/s in empty space.',
  },
  {
    id: 7,
    type: QuestionType.TRUE_OR_FALSE,
    ...
    answer: 1,
    context:
      'Even though photons have no mass, they have an observable momentum which follows the de Broglie equation.',
  },
  {
    id: 8,
    type: QuestionType.MULTIPLE_CHOICE,
    question: 'What defines the frequency of a photon?',
    options: ['Wavelength', 'Electric field', 'Frequency', 'Rest mass'],
    answer: 2,
    context:
      'The frequency of a photon is defined as how many wavelengths a photon propagates each second.',
  },
  {
    id: 9,
    type: QuestionType.MULTIPLE_CHOICE,
    ...
    answer: 3,
    context:
      'The momentum of photons leads to interesting practical applications such as optical tweezers.',
  },
  {
    id: 10,
    type: QuestionType.TRUE_OR_FALSE,
