...
class PDFWriterService {
  private indexToOptions: { [key: number]: string } = {
    0: 'A',
    1: 'B',
    2: 'C',
    3: 'D',
  ...
  createDocument = async () => {
    ...
    doc
      .fillColor('blue')
      .text('Powered by QnAI', {
        link: 'https://qnai.sewb.dev',
        align: 'center',
      })
      .fillColor('black');
  ...
  addPage = async (doc: PDFKit.PDFDocument) => {
    ...
    doc
      ...
      .fillColor('blue')
      .text('Temiloluwa Ojo', {
        link: 'https://www.linkedin.com/in/temiloluwa-ojo',
        continued: true,
        underline: true,
      })
      .fillColor('black')
      ...
      .fillColor('blue')
      .text("'Wole Ajewole", {
        link: 'https://www.linkedin.com/in/wolemercy',
        continued: true,
        underline: true,
      })
  ...
  addAnswer = async (
    ...
    doc.text(
      `${questionNumber}. ${this.indexToOptions[answerOption]} => ${qnai.options[answerOption]}`
    );
