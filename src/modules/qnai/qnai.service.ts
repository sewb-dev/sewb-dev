...
class QNAIService {
  ...
  getQuestionsFromText = async (
    ...
    4. Answers. Call this property 'answers'. Its value should be the correct answer(s) to the question. The value should be the zero-based index of the correct answer in the list of 'options'.
